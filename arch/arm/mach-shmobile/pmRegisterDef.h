...
#define	POWERDOWN_FRQCRB_ES2B   0x00231880
...
/* IRQ[0/1] FAC registers */
#define IRQ0FACPhys 0xE61C0080	/* WAKEN_STS0 IRQC Event Detector Block_0 */
#define IRQ1FACPhys 0xE61C0280	/* WAKEN_STS0 IRQC Event Detector Block_1 */
