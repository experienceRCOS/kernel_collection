...
#define NFC_VEN_GPIO		(GPIO_PORT14)
...
static struct i2c_board_info __initdata i2c_s3fwrn5[] = {
	{
...
*/
	platform_device_register(&broadcom_bluetooth_device);
...
#if defined(CONFIG_SEC_NFC)
	i2c_register_board_info(7, i2c_s3fwrn5, ARRAY_SIZE(i2c_s3fwrn5));
#endif
