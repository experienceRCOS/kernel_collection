...
static struct device_attribute mdnie_attributes[] = {
	__ATTR(mode, 0644, mode_show, mode_store),//0664
	__ATTR(scenario, 0644, scenario_show, scenario_store),
	__ATTR(outdoor, 0644, outdoor_show, outdoor_store),
	__ATTR(cabc, 0644, cabc_show, cabc_store),
	__ATTR(tunning, 0644, tunning_show, tunning_store),
	__ATTR(negative, 0644, negative_show, negative_store),
	__ATTR_NULL,
};
