...
/* sdram static area */
#define SPUV_FUNC_SDRAM_NON_CACHE_AREA_SIZE	0x3C0000
...
#define SPUV_FUNC_SDRAM_SPUV_SEND_MSG_BUFFER	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00380000)
#define SPUV_FUNC_SDRAM_RECORD_BUFFER_0		( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00381000)
#define SPUV_FUNC_SDRAM_RECORD_BUFFER_1		( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00381280)
#define SPUV_FUNC_SDRAM_PLAYBACK_BUFFER_0	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00382000)
#define SPUV_FUNC_SDRAM_PLAYBACK_BUFFER_1	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00382280)
#define SPUV_FUNC_SDRAM_VOIP_DL_TEMP_BUFFER_0	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00383000)
#define SPUV_FUNC_SDRAM_VOIP_DL_TEMP_BUFFER_1	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00383280)
#define SPUV_FUNC_SDRAM_VOIP_UL_TEMP_BUFFER_0	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00383800)
#define SPUV_FUNC_SDRAM_VOIP_UL_TEMP_BUFFER_1	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00383A80)
#define SPUV_FUNC_SDRAM_PT_PLAYBACK_BUFFER_0	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00383D00)
#define SPUV_FUNC_SDRAM_PT_PLAYBACK_BUFFER_1	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00384480)
