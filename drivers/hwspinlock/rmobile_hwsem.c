...
static int rmobile_hwsem_probe(struct platform_device *pdev)
{
	...
	if (res) {
		...
		memset(ext_base, 0, resource_size(res));
...
static int rmobile_hwsem_remove(struct platform_device *pdev)
{
