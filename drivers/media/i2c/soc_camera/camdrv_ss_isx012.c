...
*/
...

	{
		...
		.flags = 0,
				...
				{
		.ops    = &camdrv_ss_ctrl_ops,
		.id			= V4L2_CID_SHOT_PANORAMA,
		.type		= V4L2_CTRL_TYPE_INTEGER,
		.name		= "Panorama Shot ae unlock",
		.min	= 0,
		.max	= 7,
		.step		= 1,
		.def	= 0,
...
//	sensor->get_light_condition   = camdrv_ss_isx012_get_light_condition;
	...
	sensor->panorama_ae_unlock_regs			  = (regs_t *)isx012_panorama_ae_unlock_regs;
	sensor->rows_num_panorama_ae_unlock_regs	  = ARRAY_SIZE(isx012_panorama_ae_unlock_regs);
	/*AWB*/
