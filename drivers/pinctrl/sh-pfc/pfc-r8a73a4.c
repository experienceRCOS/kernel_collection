...
static const pinmux_enum_t pinmux_data[] = {
	...
	PINMUX_DATA(IRQ40_MARK,			PORT66_IN,	PORT66_FN0),
	...
	PINMUX_DATA(IRQ19_MARK,			PORT84_IN,	PORT84_FN0),
	PINMUX_DATA(IRQ18_MARK,			PORT85_IN,	PORT85_FN0),
	...
	PINMUX_DATA(IRQ41_MARK,			PORT102_IN,	PORT102_FN0),

	/* Port103 */
	PINMUX_DATA(KEYIN7_MARK,		PORT103_FN1),
	PINMUX_DATA(IRQ42_MARK,			PORT103_IN,	PORT103_FN0),
	...
	/* Port160 - Port178 */
	PINMUX_DATA(IRQ20_MARK,			PORT160_IN,	PORT160_FN0),
	PINMUX_DATA(IRQ21_MARK,			PORT161_IN,	PORT161_FN0),
	PINMUX_DATA(IRQ22_MARK,			PORT162_IN,	PORT162_FN0),
	PINMUX_DATA(IRQ23_MARK,			PORT163_IN,	PORT163_FN0),
	...
	PINMUX_DATA(IRQ24_MARK,			PORT175_IN,	PORT175_FN0),
	PINMUX_DATA(IRQ25_MARK,			PORT176_IN,	PORT176_FN0),
	PINMUX_DATA(IRQ26_MARK,			PORT177_IN,	PORT177_FN0),
	PINMUX_DATA(IRQ27_MARK,			PORT178_IN,	PORT178_FN0),
	...
	/* Port192 - Port200 IRQ */
	PINMUX_DATA(IRQ31_MARK,			PORT192_IN,	PORT192_FN0),
	PINMUX_DATA(IRQ32_MARK,			PORT193_IN,	PORT193_FN0),
	PINMUX_DATA(IRQ33_MARK,			PORT194_IN,	PORT194_FN0),
	PINMUX_DATA(IRQ34_MARK,			PORT195_IN,	PORT195_FN0),
	PINMUX_DATA(IRQ35_MARK,			PORT196_IN,	PORT196_FN0),
	PINMUX_DATA(IRQ36_MARK,			PORT197_IN,	PORT197_FN0),
	PINMUX_DATA(IRQ37_MARK,			PORT198_IN,	PORT198_FN0),
	PINMUX_DATA(IRQ38_MARK,			PORT199_IN,	PORT199_FN0),
	PINMUX_DATA(IRQ39_MARK,			PORT200_IN,	PORT200_FN0),
	...
	PINMUX_DATA(IRQ52_MARK,			PORT296_IN,	PORT296_FN0),
	...
	PINMUX_DATA(IRQ50_MARK,			PORT301_IN,	PORT301_FN0),
	...
	/* Port320 - Port329 */
	PINMUX_DATA(IRQ16_MARK,			PORT320_IN,	PORT320_FN0),
	PINMUX_DATA(IRQ17_MARK,			PORT321_IN,	PORT321_FN0),
	PINMUX_DATA(IRQ28_MARK,			PORT322_IN,	PORT322_FN0),
	PINMUX_DATA(IRQ29_MARK,			PORT323_IN,	PORT323_FN0),
	PINMUX_DATA(IRQ30_MARK,			PORT324_IN,	PORT324_FN0),
	PINMUX_DATA(IRQ53_MARK,			PORT325_IN,	PORT325_FN0),
	PINMUX_DATA(IRQ54_MARK,			PORT326_IN,	PORT326_FN0),
	PINMUX_DATA(IRQ55_MARK,			PORT327_IN,	PORT327_FN0),
	PINMUX_DATA(IRQ56_MARK,			PORT328_IN,	PORT328_FN0),
	PINMUX_DATA(IRQ57_MARK,			PORT329_IN,	PORT329_FN0),
};
