...
struct sh_mobile_lcdc_info {
	...
	struct fb_panel_func (*panel_func)(int panel);
};
...
extern struct fb_panel_func r_mobile_s6e88a0_panel_func(int panel);
extern struct fb_panel_func r_mobile_nt35510_panel_func(int panel);
extern struct fb_panel_func r_mobile_nt35516_panel_func(int panel);
extern struct fb_panel_func r_mobile_HX8389b_panel_func(int panel);
extern struct fb_panel_func r_mobile_HX8389b_truly_panel_func(int panel);
extern struct fb_panel_func r_mobile_HX8369b_panel_func(int panel);
extern struct fb_hdmi_func r_mobile_hdmi_func(void);
extern struct fb_panel_func r_mobile_nt35590_panel_func(int panel);
extern struct fb_panel_func r_mobile_hx8369b_panel_func(int panel);
