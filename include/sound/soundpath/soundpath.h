...
#define VOICECALL_DEBUG_LEVEL	"voicecall_debug_level"
...
#define VOICECALL_DEBUG_LEVEL_MAX	(0x3)
/* #define SOUND_TEST */
#define NO_INTURRUPT
#ifdef SOUND_TEST
...
/* Voice call debug */
enum sndp_voicecall_debugging_level {
	SNDP_VOICECALL_DEBUG_OFF = 0,
	SNDP_VOICECALL_DL_DEBUG,
	SNDP_VOICECALL_UL_DEBUG,
	SNDP_VOICECALL_DL_UL_DEBUG,
};
