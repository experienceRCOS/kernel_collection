...
COMMON_CTRL_NO_EXTERN int audio_ctrl_func(
...
COMMON_CTRL_NO_EXTERN void common_set_register(
	...
	u_int size);
COMMON_CTRL_NO_EXTERN int common_set_pll22(const u_int uiValue, int stat,
							u_int rate);
COMMON_CTRL_NO_EXTERN int common_set_fsi2cr(u_int dev, int stat);
